...
1. **Schema-First Alignment**:
   - Mọi Data Model (Product, Supplier, WarehouseMovement, StockMovementLog) & Auth DTOs phải định nghĩa trước trong `packages/shared-types`.
...
5. **Frontend Guidelines (`apps/web`)**:
   ...
   - Đảm bảo thiết kế giao diện Premium theo skill `design-taste-frontend`.
